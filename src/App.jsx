    ...
    <div className="App">
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/info/*" element={<MediaInfoPage providersList={providersList} addWatchList={addWatchList} addToWatchHistory={addToWatchHistory} username={username} email={email} isLoggedIn={isLoggedIn} watchList={watchList}/>} />
